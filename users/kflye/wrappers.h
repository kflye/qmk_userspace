...
#define ___________________NUM_R1___________________    TD(TD_QWERTY),     TD(TD_BOOT),       VRSN,              SHRUG,             SK_Win,            _______
#define ___________________NUM_R2___________________    TD(TD_RBT),        KC_AE,             KC_OE,             KC_AA,             SK_Mac,            _______
#define ___________________NUM_R3___________________    TD(TD_BASE),       TD(TD_GAMING),     TD(TD_ALT),        TD(TD_EECLEAR),    SK_Lux,            _______
